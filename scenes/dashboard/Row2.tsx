 ...
 const pieColors=[palette.tertiary[500],palette.secondary[300]];
  ...
  return (
   <>
    ...
    <DashboardBox gridArea="d"  style={{height:288}}>
    ...
    <DashboardBox gridArea="e" style={{height:184}}>
    <BoxHeader title="Campaigns and Targets" sideText="+3.96%" />
    ...
    <DashboardBox gridArea="f" style={{height:288}}>
